...
public class MSDAFactory extends GraduateProgramFactory {
    public MSDAFactory(ProgramType type, ArrayList<Course> coreCoursesList, ArrayList<Course> electiveCoursesList) {
